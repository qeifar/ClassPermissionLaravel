...
## ----------- FOR INCLUDE IN YOUR EXISTING PROJECT --------
# First -> Install Backpack
...
``` 
Note: If you'd also like to enable the file manager functionality, reply "yes" when the installer asks you. By default it lets users manage the public/uploads directory, but you can change that in the elfinder.php config file.
...
``` 
# Second -> Backpack\PermissionManager
...
- [Link Install Backpack][https://backpackforlaravel.com/docs/3.4/installation]  
- [Link Install Demo][https://backpackforlaravel.com/docs/3.4/demo] 
